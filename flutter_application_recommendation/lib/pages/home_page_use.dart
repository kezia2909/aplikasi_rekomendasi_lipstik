...
class HomePageUse extends StatefulWidget {
  final User firebaseUser;
  const HomePageUse({Key? key, required this.firebaseUser}) : super(key: key);
  @override
  State<HomePageUse> createState() => _HomePageUseState();
}

class _HomePageUseState extends State<HomePageUse> {
